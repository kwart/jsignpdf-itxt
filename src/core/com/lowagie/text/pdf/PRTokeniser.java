/*
 * $Id: PRTokeniser.java,v 1.2 2010/05/14 08:29:53 kwart Exp $
 *
...
/**
 * Tokenizer used to parse PDF input.
 * 
...
public class PRTokeniser {
	...
	public static final boolean delims[] = { true, true, false, false, false, false, false, false, false, false, true,
			...
			true, true, false, false, false, false, false, true, false, false, false, false, false, false, false,
	...
	public boolean nextToken() throws IOException {
		...
		if (baos != null) {
			...
			// handle UTF-16BE
			if (tokenBytes.length > 2 && tokenBytes[0] == -2 && tokenBytes[1] == -1) {
				final byte[] bomStrippedBytes = new byte[tokenBytes.length - 2];
				System.arraycopy(tokenBytes, 2, bomStrippedBytes, 0, bomStrippedBytes.length);
				stringValue = new String(bomStrippedBytes, "UTF-16BE");
			} else {
				stringValue = new String(tokenBytes);
			}
		}
		return true;
	}
